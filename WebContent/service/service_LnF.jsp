                ...
                <div class="col-md-9 col-sm-7">
                         ...
                         <div class="col-sm-12 col-md-12">
                            <div class="single-blog single-column">
					            ...
					            <%
					                ...
					                LBoardBean board=new LBoardBean();
					                Integer result=(Integer)session.getAttribute("result");
					                
					                Vector<LBoardBean> vec = new Vector<LBoardBean>();
					         if(result != null){
					        	 if(result == 2){
				                ...
				                vec=bdao.ugetAllBoard(id, startRow, endRow);
					           	...
					           	%>
                                    ...
                                    <c:if test="${result == 3 }">
                                    	<div class="right-box"><a href="lboardWriteForm.jsp">글쓰기</a></div>
                                    </c:if>
                                    <br><br>
					                <form>
					                	<table width="800" class="line">
					                		<tr class="line">
					                			...
					                			<td width="100" align="center"><b>장소</b></td>
							        		...
							        		<tr height="40" class="line">
							        			...
							        			<td width="100" align="center"><%=bean.getId() %></td>
							         		    <td width="400" align="left">
							          		  	<a href="lboardInfo.jsp?num=<%=bean.getNum() %>" style="text-decoration:none">
					...
					<%
							if(count > 0){
								...
								if(startPage > 10){
					%>
									<li class="left"><a href="service_LnF.jsp?pageNum=<%=startPage-10 %>">left</a></li>
					<%
								}
												
								for(int i=startPage;i<=endPage;i++){
					%>
									<li><a href="service_LnF.jsp?pageNum=<%=i %>"><%=i %></a></li>
					<% 
								}
												
								if(endPage < pageCount){
					%>
									<li class="right"><a href="service_LnF.jsp?pageNum=<%=startPage+10 %>">right</a></li>
					<%
								}
							}
					%>		
