...
<%
	...
	Vector<MovieVO> mov=mdao.Movie(1);
%>
<div align="center">
<h2>영화 목록</h2>
	<table width="800" border="1">
		<tr height="50">
			...
			<td align="center" width="200">부제목</td>
			...
			<td align="center" width="200">상영시간</td>
		...
		%>
			<tr height="50">
				...
				<td align="center" width="200"><%=mvo.getMsubname()%></td>
				...
				<td align="center" width="200"><%=mvo.getMtime()%></td>
