...
<body>
	...
	Vector<MovieVO> mov=mdao.Movie(7);
%>
	...
	<section id="portfolio-information" class="padding-top">
		<div class="container">
			...
			<div class="row">
               ...
               <li><a class="btn btn-default active" href="../movie/movie_detail_light.jsp" data-filter="*">주요정보</a></li>
               <li><a class="btn btn-default"  href="movie_time_day1.jsp" data-filter=".logos">상영시간표</a></li>
            </ul>
				<!--/#portfolio-filter-->
				<div class="col-sm-3">
					<!-- col-sm-3으로 하면 글씨랑 사진 딱 붙음 -->
					<img src="../movie/images/light.jpg" style="height: 350px;"
			...
			<div align="left" class="row2" style="margin: 0; padding-right: 250px;">
				...
				<div id="progressbar-container">
					<div id="video-container">
						<div class="row">
							<div class="col-md-6">
								<iframe src="https://www.youtube.com/embed/F9ubxMXQmNw" style="height: 300px; width:400px;"></iframe>
							</div>
							<div class="col-md-6">
								<iframe src="https://www.youtube.com/embed/nUZDOPPBKa0" style="height: 300px; width:400px;"></iframe>
							</div>
						</div>
					</div>
					<!--/#video-container-->
					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							<div class="item active">
								<img src="../movie/images/light_cut1.jpg" style="width:1140px; height:487px;" alt="">
							</div>
							<div class="item">
								<img src="../movie/images/light_cut2.jpg" style="width:1140px; height:487px;" alt="">
								<div class="carousel-caption">
								</div>
							</div>
							<div class="item">
								<img src="../movie/images/light_cut3.jpg" style="width:1140px; height:487px;" alt="">
								<div class="carousel-caption">
								</div>
							</div>
						</div>
